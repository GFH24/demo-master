...
urlpatterns = patterns(
    ...
    (r'^restart_vulnscan_task/$', 'restart_vulnscan_task'),
    (r'^stop_vulnscan_task/$', 'stop_vulnscan_task'),
    (r'^delete_vulnscan_task/$', 'delete_vulnscan_task'),
    (r'^get_vulnscan_report/$', 'get_vulnscan_report'),
    (r'^get_vulnscan_report_chartdata/$', 'get_vulnscan_report_chartdata'),
